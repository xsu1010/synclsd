...
- [ ] ▶ **M4** _[hw]_ — Seed-push one `.lsd` via Contents API `PUT`; confirm the commit on GitHub. First end-to-end success. _(built; **awaiting hardware verification** — boot, confirm `PUSHED OK`, then check GitHub for the commit + file)_
